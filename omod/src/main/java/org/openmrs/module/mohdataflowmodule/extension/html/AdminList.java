...
public class AdminList extends AdministrationSectionExt {
	...
	public String getTitle() {
		return "mohdataflowmodule.title";
	}
	...
	public Map<String, String> getLinks() {
		...
		map.put("module/mohdataflowmodule/history.form", "Medical History");
		map.put("module/mohdataflowmodule/medicalhistoryconfig.form","Medical History Configuration");
		return map;
	}
}